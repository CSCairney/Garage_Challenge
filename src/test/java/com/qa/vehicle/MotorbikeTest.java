...
public class MotorbikeTest {
	...
	Motorbike testMe = new Motorbike("toyota", "Micra", 2010, 4, 51, "White", 5, false);

	@Test
	public void testToString() {
		assertEquals(("Motorbike Make=" + testMe.getMake() + ", Model=" + testMe.getModel() + ", Year="
				+ testMe.getYear() + ", Wheels=" + testMe.getWheels() + ", Millage=" + testMe.getMPG() + ", Colour="
				+ testMe.getColour() + ", Windows=" + testMe.getWindows() + ", automatic=" + testMe.getAutomatic()),
				testMe.toString());
	}
	...
	@Test
	public void testGetAutomatic() {
		assertEquals(false, testMe.getAutomatic());
	}
	...
	public void testSetAutomatic() {
		testMe.setAutomatic(true);
		assertEquals(true, testMe.getAutomatic());
	}
